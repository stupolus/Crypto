...
Дата: 2026-05-20
Статус: в работе. Фазы 1A-1C готовы (модели, протокол, ошибки, нормализация, маскирование, market-data адаптеры BingX/Bybit). Локально зелёно: ruff/format/mypy strict/pytest 47. Фазы 1D-1G — впереди.
