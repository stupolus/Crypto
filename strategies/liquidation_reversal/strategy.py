...
⚠️ AUDIT-DEPRECATED 2026-05-27: см. `retro/2026-05-27-аудит-щукина.md`.
Никогда не валидирована WF (нет данных нужного качества на тарифе
пользователя). Параметры — без документальной базы (папка
`бизнес/материалы/курсы/dmitry-shukin/` пуста). Удалена из choices
раннеров; код+тесты сохранены как историческое до повторного аудита.
